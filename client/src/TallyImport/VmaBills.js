...
/**
 * Converts Excel data to Tally XML client-side for VMA Bills.
 */
    ...
    for (let i = 1; i < data.length; i++) {
        ...
        if (lastValidSeq !== null && currentSeq > lastValidSeq + 1) {
            for (let missingSeq = lastValidSeq + 1; missingSeq < currentSeq; missingSeq++) {
                const missingBillNumber = `${CONFIG.BILL_FORMAT.PREFIX}${missingSeq}`;
...
function buildNormalXML(dateFormatted, billNumber, paymentMode, targetTotal, narration) {
    ...
    xml += `      <VATDEALERTYPE>Regular</VATDEALERTYPE>\n`;
    ...
    xml += `      <TAXUNITNAME>Default Tax Unit</TAXUNITNAME>\n`;
    xml += `      <VOUCHERTYPENAME>${CONFIG.VOUCHER.TYPE}</VOUCHERTYPENAME>\n`;
    ...
    xml += `        <OLDAUDITENTRYIDS>-1</OLDAUDITENTRYIDS>\n`;
    xml += `       </OLDAUDITENTRYIDS.LIST>\n`;
    xml += `       <APPROPRIATEFOR>&#4; Not Applicable</APPROPRIATEFOR>\n`;
    ...
    xml += `       <AMOUNT>-${targetTotalStr}</AMOUNT>\n`;
    ...
    xml += `       <ISCAPVATTAXALTERED>No</ISCAPVATTAXALTERED>\n`;
    xml += `       <ISCAPVATNOTCLAIMED>No</ISCAPVATNOTCLAIMED>\n`;
    xml += `       <AMOUNT>${salesAmountStr}</AMOUNT>\n`;
    xml += `       <VATEXPAMOUNT>${salesAmountStr}</VATEXPAMOUNT>\n`;
    xml += `       <SERVICETAXDETAILS.LIST>       </SERVICETAXDETAILS.LIST>\n`;
    xml += `       <CATEGORYALLOCATIONS.LIST>\n`;
    xml += `        <CATEGORY>Primary Cost Category</CATEGORY>\n`;
    xml += `        <ISDEEMEDPOSITIVE>No</ISDEEMEDPOSITIVE>\n`;
    xml += `        <COSTCENTREALLOCATIONS.LIST>\n`;
    xml += `         <NAME>${CONFIG.LEDGERS.COST_CENTRE}</NAME>\n`;
    xml += `         <AMOUNT>${salesAmountStr}</AMOUNT>\n`;
    xml += `        </COSTCENTREALLOCATIONS.LIST>\n`;
    xml += `       </CATEGORYALLOCATIONS.LIST>\n`;
    xml += `       <BANKALLOCATIONS.LIST>       </BANKALLOCATIONS.LIST>\n`;
    ...
    xml += `        <GSTRATE> ${CONFIG.TAX_INFO.CGST_RATE}</GSTRATE>\n`;
    xml += `       </RATEDETAILS.LIST>\n`;
    xml += `       <RATEDETAILS.LIST>\n`;
    xml += `        <GSTRATEDUTYHEAD>SGST/UTGST</GSTRATEDUTYHEAD>\n`;
    xml += `        <GSTRATEVALUATIONTYPE>Based on Value</GSTRATEVALUATIONTYPE>\n`;
    xml += `        <GSTRATE> ${CONFIG.TAX_INFO.SGST_RATE}</GSTRATE>\n`;
    xml += `       </RATEDETAILS.LIST>\n`;
    xml += `       <RATEDETAILS.LIST>\n`;
    xml += `        <GSTRATEDUTYHEAD>IGST</GSTRATEDUTYHEAD>\n`;
    xml += `        <GSTRATEVALUATIONTYPE>Based on Value</GSTRATEVALUATIONTYPE>\n`;
    xml += `        <GSTRATE> ${CONFIG.TAX_INFO.IGST_RATE}</GSTRATE>\n`;
    xml += `       </RATEDETAILS.LIST>\n`;
    xml += `       <RATEDETAILS.LIST>\n`;
    ...
    xml += `       <ISCAPVATTAXALTERED>No</ISCAPVATTAXALTERED>\n`;
    xml += `       <ISCAPVATNOTCLAIMED>No</ISCAPVATNOTCLAIMED>\n`;
    xml += `       <AMOUNT>${sgstAmountStr}</AMOUNT>\n`;
    xml += `       <VATEXPAMOUNT>${sgstAmountStr}</VATEXPAMOUNT>\n`;
    xml += `       <SERVICETAXDETAILS.LIST>       </SERVICETAXDETAILS.LIST>\n`;
    xml += `       <BANKALLOCATIONS.LIST>       </BANKALLOCATIONS.LIST>\n`;
    xml += `       <BILLALLOCATIONS.LIST>       </BILLALLOCATIONS.LIST>\n`;
    xml += `       <INTERESTCOLLECTION.LIST>       </INTERESTCOLLECTION.LIST>\n`;
    ...
    xml += `       <ISCAPVATTAXALTERED>No</ISCAPVATTAXALTERED>\n`;
    xml += `       <ISCAPVATNOTCLAIMED>No</ISCAPVATNOTCLAIMED>\n`;
    xml += `       <AMOUNT>${cgstAmountStr}</AMOUNT>\n`;
    xml += `       <VATEXPAMOUNT>${cgstAmountStr}</VATEXPAMOUNT>\n`;
    xml += `       <SERVICETAXDETAILS.LIST>       </SERVICETAXDETAILS.LIST>\n`;
    xml += `       <BANKALLOCATIONS.LIST>       </BANKALLOCATIONS.LIST>\n`;
    xml += `       <BILLALLOCATIONS.LIST>       </BILLALLOCATIONS.LIST>\n`;
    xml += `       <INTERESTCOLLECTION.LIST>       </INTERESTCOLLECTION.LIST>\n`;
