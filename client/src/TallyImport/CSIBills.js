...
const CONFIG = {
    ...
    VOUCHER: {
        TYPE: "Counter Sale (Spares-Sales)",
        CLASS: "Default Voucher Class"
    },

    // Bill Format Configuration
    BILL_FORMAT: {
        // Strictly matches "1/CSI/" followed by exactly 8 digits
        REGEX: /^1\/CSI\/(\d{8})$/i,
        PREFIX: "1/CSI/"
    },
...
/**
 * Converts Excel data to Tally XML client-side.
 */
export async function processFileClientSide(file, fromDateStr = null, toDateStr = null) {
    if (!file) {
    ...
    const colIdx = {
        ...
        amount: headers.indexOf(CONFIG.EXCEL_MAPPING.TOTAL.toUpperCase()),
