...
// Called by the frontend whenever a receipt is created/edited/cancelled,
// and by the bulk_delete utility for bulk operations.
router.post('/', async (req, res) => {
    ...
    const validActions = ['CREATED', 'EDITED', 'CANCELLED', 'DELETED', 'BULK_DELETED'];
