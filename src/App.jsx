...
function App() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      {/* Sidebar Navigation */}
      <div className={`fixed right-0 top-0 h-full w-20 ${
        isDark ? 'bg-gray-800/80 backdrop-blur-sm border-l border-gray-700' : 'bg-white/80 backdrop-blur-sm border-l border-gray-200'
        ...
        {/* Divider */}
        <div className={`w-12 h-px ${isDark ? 'bg-gray-700' : 'bg-gray-300'}`}></div>
        ...
        {pages.map((page) => {
          ...
          return (
            ...
            >
              ...
              {/* Tooltip */}
              <span className={`absolute right-full mr-3 px-3 py-1 rounded-lg text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none ${
